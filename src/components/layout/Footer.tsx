        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Share your travel adventures and discover amazing destinations from 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/countries" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Countries
                </Link>
              </li>
            </ul>
